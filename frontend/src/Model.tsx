...
Command: npx gltfjsx@6.1.4 scene.gltf -t -r public
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('public/chain_link_fence_material/scene.gltf') as GLTFResult
  return (
...
useGLTF.preload('public/chain_link_fence_material/scene.gltf')
